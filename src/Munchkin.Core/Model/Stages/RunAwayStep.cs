...
{
    public class RunAwayStep : IHierarchialStep<Table>
    {
        ...
        public RunAwayStep(Player fightingPlayer, Player helpingPlayer, IReadOnlyCollection<MonsterCard> monsters, List<Card> playedCards)
        {
