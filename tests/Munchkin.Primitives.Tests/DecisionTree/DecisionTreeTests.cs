...
namespace Munchkin.Core.Tests.Primitives
{
    public class DecisionTreeTests
    {
        ...
        public void From_WithNotNullParameter_ShouldntThrowArgumentException()
        {
            ...
            // Act
            var exception = Record.Exception(() => DecisionTree<Table>.Empty());
        ...
        public void From_WithNotNullParameter_ShouldReturnNotNullResult()
        {
            ...
            // Act
            var result = DecisionTree<Table>.Empty().Then(step);
        ...
        public void From_WithNotNullParameter_ShouldReturnStepConfigurationTypeInstance()
        {
            ...
            // Assert
            Assert.IsAssignableFrom<IDecisionTreeBuilder<Table>>(result);
        }
        ...
        public async void ExecuteAsync_WithNullParameter_ShouldThrowArgumentNullException()
        {
            ...
            var decisionTree = DecisionTree<Table>
                .Empty()
                .Then(step1)
                .Then(step2)
                .Build();
        ...
        public async void ExecuteAsync_WithStepsUnderCondition_ShouldResolve2OutOf3Steps()
        {
            ...
            var branch1Builder = new Func<IDecisionTreeContext<Table>, IDecisionTreeBuilder<Table>>(branch1 => branch1.Then(step2.Object));
            var branch2Builder = new Func<IDecisionTreeContext<Table>, IDecisionTreeBuilder<Table>>(branch2 => branch2.Then(step3.Object));
        ...
        public void Then_WithNullParameter_ShouldThrowArgumentNullException()
        {
            ...
            // Act
            var builder = DecisionTree<Table>.Empty();
        ...
        public void Build_ShouldReturnDecisionTreeInstance()
        {
            ...
            Assert.IsType<DecisionTree<Table>>(decisionTree);
        }
    }
}
