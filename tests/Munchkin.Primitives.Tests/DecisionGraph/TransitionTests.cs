...
namespace Munchkin.Core.Tests.Primitives
{
    public class TransitionTests
    {
        ...
        {
            // Act, Assert
            Assert.Throws<ArgumentNullException>(() => Transition.Create<Table, KickOpenTheDoorStep, EmptyRoomStep>(null, null));
        }
        ...
        public void Create_WithNotNullParameters_ShouldNotThrowArgumentNullException()
        {
            ...
            // Act
            var exception = Record.Exception(() => Transition.Create<Table, KickOpenTheDoorStep, CombatRoomStep>(configCreation, configCondition));
        ...
        public void Create_WithNotNullParameters_ShouldReturnTransitionInstance()
        {
            ...
            // Act
            var transition = Transition.Create<Table, KickOpenTheDoorStep, CombatRoomStep>(configCreation, configCondition);

            // Assert
            Assert.NotNull(transition);
            Assert.IsAssignableFrom<Transition<Table>>(transition);
        }
